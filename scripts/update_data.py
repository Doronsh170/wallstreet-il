...
def fetch_market_data(weekly=False):
    ...
    result_lines.extend([
        ...
        "  Gold $/oz ≈ GLD × 10.7 | Bitcoin ≈ IBIT × 550",
        "  VIXY ETF price is NOT the VIX index level. For the actual VIX level, use Google Search.",
        "  For exact index levels, oil prices ($/barrel), and VIX level: ALWAYS use Google Search.",
